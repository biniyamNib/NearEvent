...
export default function CreateEventPage() {
  ...
  const handleBannerFile = (file?: File | null) => {
    ...
    const validType = ["image/png", "image/jpeg", "image/jpg"].includes(
      file.type,
    );
    if (!validType) {
          ...
          <div className="space-y-6">
            <section className="rounded-2xl border border-border-default bg-bg-default p-5 space-y-4">
              ...
              <Input
                ...
                placeholder="Enter full address or pin location..."
            ...
            <section className="rounded-2xl border border-border-default bg-bg-default p-5 space-y-4">
              ...
              <div>
                ...
                {!bannerFile ? (
                  ...
                  <div className="rounded-xl h-31 border border-border-default bg-bg-default p-4 flex items-center justify-between gap-3">
                    <div>
